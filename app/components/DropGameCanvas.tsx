  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden">
      ...
      <div className="absolute w-full top-0 left-0 flex flex-col gap-3 p-4 z-10">
        ...
        <div className="flex justify-between items-center bg-black bg-opacity-50 backdrop-blur-sm rounded-md p-3 w-full">
      ...
      {gameOver && (
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-3 bg-black bg-opacity-30 backdrop-blur-md rounded-md">
